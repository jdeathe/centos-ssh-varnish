...
- `centos-6`, `centos-6-1.4.2`, `1.4.2` [(centos-6/Dockerfile)](https://github.com/jdeathe/centos-ssh-varnish/blob/centos-6/Dockerfile)

#### centos-6

The latest CentOS-6 based release can be pulled from the `centos-6` Docker tag. It is recommended to select a specific release tag - the convention is `centos-6-1.4.2`or `1.4.2` for the [1.4.2](https://github.com/jdeathe/centos-ssh-varnish/tree/1.4.2) release tag.
